    ...
    def handle_client_request(new_socket):
        ...
        if request_path.endswith(".html"):
            ...
            try:
                ...
                with open("D:/APPS/Microsoft VS Code/new_works/python41-进阶/day14/01-web框架开发/static" + request_path, "rb") as file:  # 这里的file表示打开文件的对象
                    file_data = file.read()
                ...
                # 读取404页面数据
                with open("D:/APPS/Microsoft VS Code/new_works/python41-进阶/day14/01-web框架开发/static/error.html", "rb") as file:
                    file_data = file.read()
